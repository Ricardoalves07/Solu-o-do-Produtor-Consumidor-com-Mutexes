...
typedef struct {
    ...
    int total_itens;   // Total de itens a serem produzidos/consumidos
    int produced_itens; // Contador de itens produzidos
    int consumed_itens; // Contador de itens consumidos
...
void* producer(void *arg) {
    ...
    //Lê os argumentos do buffer_t inicializados no main
    ...
    while (1) { 
        ...
        if (buffer->produced_itens >= buffer->total_itens) {
        ...
        ++buffer->produced_itens; // Incrementa o contador de itens produzidos
...
void* consumer(void *arg) {
    ...
    while (1) { 
        ...
        if (buffer->consumed_itens >= buffer->total_itens) {
            pthread_mutex_unlock(&buffer->mutex); // Destrava o mutex
        ...
        ++buffer->consumed_itens; // Incrementa o contador de itens consumidos
...
int main(int argc, char *argv[]) {
    ...
    buffer_t buffer = {
        ...
        .total_itens = total_items, // Define o número total de itens a serem produzidos/consumidos
        .produced_itens = 0, // Inicializa o contador de itens produzidos
        .consumed_itens = 0, // Inicializa o contador de itens consumidos
